...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
           <div class="card-body">
             <h1><i class="fa fa-list"></i> Template Gallery</h1>
              <?php if ($this->session->userdata('role') == 'admin'): ?>
                <a href="<?php echo base_url('admin/pages/upload'); ?>" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Upload</a> &nbsp;
                <a href="" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Create</a> &nbsp;
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                           ...
                           <!-- <?php //foreach ($users as $user): ?>-->
                                ...
                                <td><img src="<?php echo base_url('assets/images/background/socialbg.jpg'); ?>" width="90px" height="90px;"></td>
                                   <td><h3><a href="">clean & elegant newsletter template</a></h3>
                                    <h6>Lois's</h6>
                                    <p>created at 2019-1-20</p></td>
                                <td>Upload Type</td>
