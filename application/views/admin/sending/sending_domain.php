...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
           <div class="card-body">
             <h1><i class="fa fa-list"></i> sending domains</h1>
              <?php if ($this->session->userdata('role') == 'admin'): ?>
                <a href="<?php echo base_url('admin/ui/typography'); ?>" class="btn btn-info pull-right"><i class="fa fa-plus"></i> New sending domain</a> &nbsp;
                    ...
                    <div class="table-responsive m-t-40">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                           ...
                           <!-- <?php //foreach ($users as $user): ?>-->
                             ...
                             <tr>
                                <td>
                                 <center><i class="fa fa-globe" aria-hidden="true" style="font-size: 167px;"></i>
