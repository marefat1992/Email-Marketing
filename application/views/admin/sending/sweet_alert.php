...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
           <div class="card-body">
             <h1><i class="fa fa-list"></i> Email verification servers</h1><br>
             <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
             tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
            .</p>
              <?php if ($this->session->userdata('role') == 'admin'): ?>
                <a href="<?php echo base_url('admin/ui/vector_map'); ?>" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Create New</a> &nbsp;
                   <!-- Large button groups (default and split) -->
                       <!-- Example split danger button -->
                       <div class="col-sm-3" style="width: 120px;">
                              <select class="selectpicker m-b-20" data-style="btn-default">
                                   <option data-tokens="ketchup mustard">Name</option>
                    ...
                    <?php if(check_power(1)):?>
                        <a href="<?php //echo base_url('admin/user') ?>" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Create New</a>
                    <?php endif; ?>
                <?php endif ?>
