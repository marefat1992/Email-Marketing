...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Customer</span></a>
                            <ul aria-expanded="false" class="collapse">

                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/user/all_user_list') ?>"><i class="fa fa-angle-right"></i> Customers</a></li>
                                    <li><a href="<?php echo base_url('admin/user/power') ?>"><i class="fa fa-angle-right"></i> subscriptions</a></li>
                                <?php else: ?>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-credit-card"></i><span class="hide-menu">plan</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/form/general') ?>"><i class="fa fa-angle-right"></i> currencies </a></li>
                                <li><a href="<?php echo base_url('admin/form/addons') ?>"><i class="fa fa-angle-right"></i> payment methods1</a></li>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-user-o" aria-hidden="true"></i><span class="hide-menu">Admin</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/table/basic') ?>"><i class="fa fa-angle-right"></i>Admins</a></li>
                                <li><a href="<?php echo base_url('admin/table/layout') ?>"><i class="fa fa-angle-right"></i>Admin group</a></li>
                            </ul>
                        </li>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-exchange" aria-hidden="true"></i><span class="hide-menu">sending</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/ui/cards') ?>"><i class="fa fa-angle-right"></i>sending servers</a></li>
                                <li><a href="<?php echo base_url('admin/ui/bootstrap_ui') ?>"><i class="fa fa-angle-right"></i> Sub accounts</a></li>
                                <li><a href="<?php echo base_url('admin/ui/modals') ?>"><i class="fa fa-angle-right"></i> Bounce handlers</a></li>
                                <li><a href="<?php echo base_url('admin/ui/tabs') ?>"><i class="fa fa-angle-right"></i> Feedback loop handlers</a></li>
                                <li><a href="<?php echo base_url('admin/ui/tooltip') ?>"><i class="fa fa-angle-right"></i> sending domains</a></li>
                                <li><a href="<?php echo base_url('admin/ui/sweet_alert') ?>"><i class="fa fa-angle-right"></i>Email verification servers</a></li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/pages/blank') ?>"><i class="fa fa-angle-right"></i> All settings</a></li>
                                <li><a href="<?php echo base_url('admin/pages/profile') ?>"><i class="fa fa-angle-right"></i> Template Gallery</a></li>
                                <li><a href="<?php echo base_url('admin/pages/register') ?>"><i class="fa fa-angle-right"></i> Register</a></li>
                                <li><a href="<?php echo base_url('admin/pages/lockscreen') ?>"><i class="fa fa-angle-right"></i> Language</a></li>
                                <li><a href="<?php echo base_url('admin/pages/login') ?>"><i class="fa fa-angle-right"></i> login</a></li>
                                <li><a href="<?php echo base_url('admin/pages/recover') ?>"><i class="fa fa-angle-right"></i> recover</a></li>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-file-text-o" aria-hidden="true"></i><span class="hide-menu">report</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/ui/google_map') ?>"><i class="fa fa-angle-right"></i> Blacklist</a></li>
                                <li><a href="<?php echo base_url('admin/ui/vector_map') ?>"><i class="fa fa-angle-right"></i> Tracking log</a></li>
                                <li><a href="<?php echo base_url('admin/ui/vector_map') ?>"><i class="fa fa-angle-right"></i> Tracking log</a></li>
                                <li><a href="<?php echo base_url('admin/ui/vector_map') ?>"><i class="fa fa-angle-right"></i> Tracking log</a></li>
                                <li><a href="<?php echo base_url('admin/ui/vector_map') ?>"><i class="fa fa-angle-right"></i> Tracking log</a></li>
                                <li><a href="<?php echo base_url('admin/ui/vector_map') ?>"><i class="fa fa-angle-right"></i> Tracking log</a></li>
    ...
    <script src="<?php echo base_url() ?>assets/plugins/styleswitcher/jQuery.style.switcher.js"></script>
      <script src="<?php echo base_url()?>assets/js/drop.js" type="text/javascript"></script>
