...
class Table extends CI_Controller {
    ...
    public function basic(){
        ...
        $data['main_content'] = $this->load->view('admin/admins/basic', $data, TRUE);
        $this->load->view('admin/index', $data);
    }
    ...
    public function layout(){
        ...
        $data['main_content'] = $this->load->view('admin/admins/layout', $data, TRUE);
        $this->load->view('admin/index', $data);
    }
    ...
    public function datatable(){
        ...
        $data['main_content'] = $this->load->view('admin/admins/datatable', $data, TRUE);
        $this->load->view('admin/index', $data);
    }
