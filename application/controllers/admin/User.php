...
class User extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['main_content'] = $this->load->view('admin/customers/add', $data, TRUE);
    ...
    public function all_user_list()
    {
        ...
        $data['main_content'] = $this->load->view('admin/customers/users', $data, TRUE);
        $this->load->view('admin/index', $data);
    }
    ...
    public function update($id)
    {
        if ($_POST) {
            ...
            redirect(base_url('admin/customers/all_user_list'));
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('admin/customers/user_power', $data, TRUE);
        $this->load->view('admin/index', $data);
    }
    public function user_powers(){
        $data['main_content'] = $this->load->view('admin/customers/user_power');
        $this->load->view('admin/index', $data);
    }
    ...
    {   
        if (isset($_POST)) {
            ...
            redirect(base_url('admin/customers/power'));
        }
